...
import 'package:social_network/Services/auth_methods.dart';
...
import 'package:social_network/Widgets/follow_button.dart';
  ...
  void getData() async {
    ...
    try {
      ...
      isFollowing = userSnap
          .data()!['followers']
          .constains(FirebaseAuth.instance.currentUser!.uid);
      setState(() {});
    } catch (e) {
      showSnackBar(
        context,
